...
def assign_rosetta_types(atoms): #{{{
    ...
    for i, a in enumerate(atoms): # i just used for debugging output
        ...
        if a.is_virtual:
            ...
            bonded_to_N_O = count_bonded(a, lambda x: x.elem == "N") #  ADDED BY KIRUBA to handle Nitro group
            ...
            if is_saturated(a):
                ...
                elif bonded_to_N_O: a.ros_type = "aroC" #  ADDED BY KIRUBA to handle Nitro group
            ...
            elif bonded_to_N:       a.ros_type = "aroC" #  MODIFIED BY KIRUBA to handle Nitro group
