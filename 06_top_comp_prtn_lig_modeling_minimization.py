...
rosetta_mini_score_app = f"/home/jaime/tmp/rosetta/Rosetta/main/source/bin/bou-min-ubo-nrg-jump.default.linuxgccrelease"
...
os.makedirs("mini_protein_ligand_complex_of_all_models", exist_ok=True)
